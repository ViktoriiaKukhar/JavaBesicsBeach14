...
public class HWTask6 {
	...
	public static void main(String[] args) {
		 ...
		 *  until the user enters the EXACT amount . If the user gives more 
		 *  than coffee price --> ask them to give less, if the user gives 
		 *  less money then ask to give more. Once user give EXACT amount
